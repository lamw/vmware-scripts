...
$VCFLicenseServerFQDN = "vcf-lic02.vcf.lab"
$VCFIdentityBrokerFQDN = "vcf-idb02.vcf.lab"
...
$VCFManagementServicesFleetFQDN = "vcf-flt02.vcf.lab"
$VCFManagementServicesInstanceFQDN = "vcf-int02.vcf.lab"
$VCFManagementServicesIps = @("172.30.0.170","172.30.0.172","172.30.0.173","172.30.0.174","172.30.0.175","172.30.0.176","172.30.0.177","172.30.0.178","172.30.0.179","172.30.0.180","172.30.0.181","172.30.0.182") # Minimum of 12 IPs & Maximum of 30 IPs
$VCFManagementServicesInternalClusterCIDR = "198.18.0.0/15"
...
if($ValidateOnly -eq $false) {
    My-Logger "Starting VCF Management Services (VCFMS) Deployment ..."
